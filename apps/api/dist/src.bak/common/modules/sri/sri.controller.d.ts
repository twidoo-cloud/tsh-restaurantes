...
export declare class SriController {
    ...
    uploadCertificate(tenantId: string, file: any, password: string): Promise<{
        success: boolean;
        message: string;
        certificate: {
            fileName: string;
    ...
    firmarFactura(tenantId: string, id: string): Promise<{
        id: string;
        estado: string;
        message: string;
    }>;
    enviarAlSri(tenantId: string, id: string): Promise<{
        estado: string;
    ...
    consultarEstado(tenantId: string, id: string): Promise<{
        estado: string;
        numeroAutorizacion: string;
        fechaAutorizacion: string;
        errores?: undefined;
    ...
    anularComprobante(tenantId: string, id: string, dto: AnularComprobanteDto): Promise<{
        id: string;
        estado: string;
        message: string;
    ...
    generateRide(tenantId: string, id: string): Promise<{
        id: string;
        rideUrl: string;
        message: string;
    }>;
    downloadRide(tenantId: string, id: string, res: Response): Promise<void>;
    enviarEmail(tenantId: string, id: string, dto: EnviarEmailDto): Promise<{
        success: boolean;
        message: string;
        messageId: string;
    } | {
    ...
    getInvoices(tenantId: string, page?: string, limit?: string): Promise<{
        data: ({
            order: {
