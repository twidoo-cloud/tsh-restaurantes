...
let ShiftsController = class ShiftsController {
    ...
    async getCashRegisters(tenantId) {
        return this.shiftsService.getCashRegisters(tenantId);
    }
    async getActiveShift(tenantId) {
        return this.shiftsService.getActiveShift(tenantId);
    }
    async openShift(tenantId, userId, firstName, dto) {
        const result = await this.shiftsService.openShift(tenantId, userId, dto);
    ...
    async getShifts(tenantId, query) {
        return this.shiftsService.getShifts(tenantId, query);
    }
...
__decorate([
    ...
    __param(2, (0, tenant_decorator_1.CurrentUser)('firstName')),
    __param(3, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, String, shifts_dto_1.OpenShiftDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, shifts_dto_1.ShiftQueryDto]),
    __metadata("design:returntype", Promise)
