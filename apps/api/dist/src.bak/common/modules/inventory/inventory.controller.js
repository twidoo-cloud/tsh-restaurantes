...
let InventoryController = class InventoryController {
    ...
    async getStockLevels(tenantId, categoryId, lowStockOnly, search) {
    ...
    async getMovements(tenantId, productId, movementType, page, limit) {
    ...
    async recordMovement(tenantId, userId, dto) {
        return this.inventoryService.recordMovement(tenantId, userId, dto);
    }
    async bulkAdjustment(tenantId, userId, dto) {
...
__decorate([
    ...
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, RecordMovementDto]),
    __metadata("design:returntype", Promise)
...
__decorate([
    ...
    __param(2, (0, common_1.Body)()),
    __metadata("design:type", Function),
    __metadata("design:paramtypes", [String, String, BulkAdjustmentDto]),
    __metadata("design:returntype", Promise)
