...
export class ShiftsController {
  ...
  async getCashRegisters(@CurrentTenant() tenantId: string) {
    return this.shiftsService.getCashRegisters(tenantId);
  }

  @Get('active')
  @ApiOperation({ summary: 'Obtener turno activo actual' })
  async getActiveShift(@CurrentTenant() tenantId: string) {
  ...
  async getShifts(@CurrentTenant() tenantId: string, @Query() query: ShiftQueryDto) {
